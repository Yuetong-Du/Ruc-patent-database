...
class GPatent(db.Model):
    ...
    patent_number = db.Column(db.String(36), primary_key=True)
...
class GInventorDetailed(db.Model):
    ...
    patent_number = db.Column(db.String(36), db.ForeignKey('g_patent.patent_number'), primary_key=True)
...
class GApplication(db.Model):
    ...
    application_number = db.Column(db.String(36), primary_key=True)
...
# import json
class GApplicationInProgress(db.Model):
